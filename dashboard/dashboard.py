...
if __name__ == "__main__":
    ...
    #     with cols[1]:
    #         df_top10_employers = query_job_listings(
    #             f"""
    #             SELECT
    #             SUM(VACANCIES) AS "Annonser",
    #             employer_name  AS "Arbetsgivare"
    ...
    #     with cols[2]:
    #         df_top5_region = query_job_listings(
    #             f"""
    #             SELECT
    #             workplace_region AS "Region",
    #             SUM(vacancies)   AS "Annonser"
    ...
    #             "Välj arbetsgivare:", sorted(df_all["EMPLOYER_NAME"].dropna().unique()), index=None
    #         )
    #         if selected_company:
    #             filtered = df_all.query("EMPLOYER_NAME == @selected_company")
    #             selected_headline = st.selectbox(
    #                 "Välj en jobbannons:", filtered["HEADLINE"], index=None
    #             )
    #             if selected_headline:
    #                 st.markdown(
    #                     filtered.query("HEADLINE == @selected_headline")[
